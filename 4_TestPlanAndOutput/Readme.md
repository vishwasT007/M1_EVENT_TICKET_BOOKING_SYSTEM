...
|  T_03|H_02|Display the  details of Events available|  Enter choice | Display list | Display list | PASS |
|  T_04|H_02| Purchase a ticket for the available Event | enter choice | ThankYou for Booking Ticket | ThankYou for Booking Ticket| PASS |
|  T_05|H_03|  Summary of a ticket for purchased Event | enter choice | Booking ID,Customer name,Show Name,Hallno,Price | Booking ID,Customer name,Show Name,Hallno,Price| PASS |
